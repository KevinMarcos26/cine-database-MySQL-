...
FOREIGN KEY (ID_RESERVACION) REFERENCES RESERVAS(ID));

INSERT INTO PELICULAS (NOMBRE, MINUTOS)
...
INSERT INTO SALAS (NOMBRE,ASIENTOS) 
VALUES ('Iñarritu',72),
('Cuaron',36),
('Del Toro',36);
...
INSERT INTO RESERVAS (ID_FUNCION,ID_CLIENTE)
